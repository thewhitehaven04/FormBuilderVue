...
import { getBar } from '@/features/questionAnswersBreakdown/helpers'
...
const stats = computed(() => getBar(data.value))
</script>

<template>
    <Card>
        <template #title> Multiple choice answer distribution breakdown</template>
        <template #subtitle>
